           ...
           <div class="row mg-b-25">
             ...
             <div class="col-lg-6">
               <div class="form-group">
                 ...
                 <input class="form-control" type="text" name="product_code" placeholder="Enter the Product Code">
               </div>
             </div><!-- col-4 -->
             ...
             <div class="col-lg-6">
               <div class="form-group">
                 ...
                 <input class="form-control" type="text" name="product_quantity"  placeholder="Enter the Product Quantity">
               </div>
             </div><!-- col-4 -->
             ...
             <div class="col-lg-6">
               <div class="form-group">
                 ...
                 <input class="form-control" type="text" name="discount_price"  placeholder="Enter the discount price">
               </div>
             </div><!-- col-4 -->
