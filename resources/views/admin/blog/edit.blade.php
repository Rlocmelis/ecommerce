           ...
           <div class="row mg-b-25">
             ...
             <div class="col-lg-6">
               <div class="form-group">
                 ...
                 <input class="form-control" type="text" name="post_title_lv"  value="{{ $post->post_title_lv }}">
               </div>
             </div><!-- col-4 -->
             ...
             <div class="col-lg-12">
               <div class="form-group">
                 ...
                 <textarea class="form-control" id="summernote1" name="details_lv">
                   {!! $post->details_lv !!}
                </textarea>
               </div>
             </div><!-- col-4 -->
             ...
             <div class="col-lg-4">
               <div class="form-group">
                 <label class="form-control-label">The Old Post Image: <span class="tx-danger">*</span></label>
                 <label class="custom-file">
