        ...
        <table id="datatable1" class="table display responsive nowrap">
          <thead>
            <tr>
              ...
              <th class="wd-15p">Category name LV</th>
    ...
    <ul>
        ...
        @endforeach
            ...
            <div class="modal-body pd-20">
                ...
                <div class="form-group">
                <label for="exampleInputEmail1">Category Name Latvian</label>
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Category Name Latvian" name="category_name_lv">
                </div>
